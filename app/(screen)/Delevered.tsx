...
const OrderDetailsScreen = () => {
  ...
  Delivered! <Text style={styles.emoji}>📦</Text> We hope you enjoy reading. Explore more books anytime.
</Text>
    ...
    {showUpdates && (
      <View style={styles.expandedUpdates}>
        ...
        <Text style={styles.updateItem}>
          • Your Order is Delivered (3:15 PM)
        </Text>
      </View>
    )}
  </View>
 ...
 <Text style={styles.shareText}>
  Enjoy your book! Your order is delivered. Explore more books anytime <Text style={styles.emoji}>📖✨</Text>
</Text>
