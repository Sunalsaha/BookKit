...
const OrderDetailsScreen = () => {
          ...
          <View style={styles.statusCard}>
            <View style={styles.statusContent}>
              <Text style={styles.statusTitle}>
                 Sorry!! <Text style={styles.emoji}>🙁</Text> Your order is being cancelled by Seller.
              </Text>
              ...
              {showUpdates && (
                 <View style={styles.expandedUpdates}>
                    ...
                    <Text style={styles.updateItem}>• Your order is cancelled By Seller (10:10 AM)</Text>
                 </View>
              )}
            </View>
  ...
  <Text style={styles.shareText}>
    The seller has cancelled this order, but there are many great books waiting for you. Try finding another one <Text style={styles.emoji}>😊📖</Text>
  </Text>
</View>
